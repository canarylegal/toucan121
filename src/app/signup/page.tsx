...
export default async function SignupPage({
  ...
  return (
    <main className="mx-auto w-full max-w-md px-6 py-12">
      <ToucanBrand />
      <h1 className="mt-4 font-serif text-4xl tracking-tight">Create account</h1>
      <p className="mt-2 text-muted">
        One account for booking and hosting. You can start hosting whenever
        you&apos;re ready — visitors can still book without signing up.
      </p>
