...
export function EnableLinksForm({
  defaultName,
  submitLabel = "Publish links profile",
}: {
  defaultName: string;
  submitLabel?: string;
}) {
  const [state, action, pending] = useActionState(enableLinksProfileAction, {
    values: {
      name: defaultName,
      businessName: "",
