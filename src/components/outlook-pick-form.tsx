...
import {
  cancelOutlookConnectAction,
  selectOutlookCalendarAction,
  type OutlookPickState,
...
export function OutlookPickForm({
  calendars,
  accountEmail,
  listError,
}: Props) {
  ...
  return (
    <div className="space-y-4">
      <form action={action} className="space-y-4">
        ...
        <div>
          <p className="text-sm font-medium">Choose an Outlook calendar</p>
          {accountEmail ? (
      ...
      <form action={cancelOutlookConnectAction}>
        <button
          type="submit"
